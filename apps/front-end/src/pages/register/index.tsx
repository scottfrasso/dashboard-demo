// ** React Imports
import {
  ReactNode, useState, Fragment, MouseEvent,
} from 'react';
...
function Register() {
  ...
  return (
    <Box className="content-right">
      {!hidden ? (
        <Box sx={{
          p: 12, flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center',
        }}
        >
      ...
      >
        <Box sx={{ mx: 'auto', maxWidth: 400 }}>
          ...
          <form noValidate autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
            ...
            <FormControl sx={{ mb: 4, mt: 1.5 }} error={Boolean(errors.terms)}>
              <Controller
                name="terms"
                control={control}
                rules={{ required: true }}
